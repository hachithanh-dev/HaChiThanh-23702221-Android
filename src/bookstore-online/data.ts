// Dữ liệu mẫu dùng chung cho ứng dụng BookStore Online — Hà Chí Thanh (MSSV: 23702221)
// Đáp ứng toàn bộ các bài tập thực hành Tuần 3: Giờ 1, Giờ 2, Giờ 3 & Tổng hợp.
...
export interface Book {
  ...
  price: number;
  cover: string;
  discountPercent?: number; // Giờ 3: vẽ badge "-x%"
  isNew?: boolean; // Giờ 3: vẽ badge "Mới"
  description: string;
}
...
export const BOOKS: Book[] = [
  {
    ...
    description:
      ...
      "sự trưởng thành và tình bạn. Đây là tác phẩm văn học thiếu nhi kinh điển của Việt Nam.",
  },
  {
    id: 2,
    title: "Nhà Giả Kim",
